...
% Last Modified by GUIDE v2.5 29-Nov-2012 13:19:19
...
% --- Executes during object creation, after setting all properties.
function alphaabetax_CreateFcn(hObject, eventdata, handles)
% hObject    handle to alphaabetax (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate alphaabetax
rgb = imread('alphaabetax.png');
%image(rgb); title('RGB image');
axes(hObject); % Switches focus to this axes object.
imshow(rgb); % Display it with some command such as


% --- Executes during object creation, after setting all properties.
function alnx_CreateFcn(hObject, eventdata, handles)
% hObject    handle to alnx (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate alnx
rgb = imread('alnx.png');
%image(rgb); title('RGB image');
axes(hObject); % Switches focus to this axes object.
imshow(rgb); % Display it with some command such as
...
% --- Executes during object creation, after setting all properties.
function axb_CreateFcn(hObject, eventdata, handles)
% hObject    handle to axb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate axb
rgb = imread('axb.png');
%image(rgb); title('RGB image');
axes(hObject); % Switches focus to this axes object.
imshow(rgb); % Display it with some command such as
...
% --- Executes during object creation, after setting all properties.
function oaxb_CreateFcn(hObject, eventdata, handles)
% hObject    handle to oaxb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate oaxb
rgb = imread('1axb.png');
%image(rgb); title('RGB image');
axes(hObject); % Switches focus to this axes object.
imshow(rgb); % Display it with some command such as
...
% Hint: place code in OpeningFcn to populate aixi
rgb = imread('aixi.png');
%image(rgb); title('RGB image');
axes(hObject); % Switches focus to this axes object.
imshow(rgb); % Display it with some command such as
